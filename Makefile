...
BINARIES=cosmo-pack cosmo-build cosmo-color cosmo-benchmark pack-color cosmo-color-pd #match-color # cosmo-assemble
...
cosmo-color-pd: cosmo-color-pd.cpp $(BUILD_REQS)
		$(CXX) $(CPP_FLAGS) -o $@ $< io.o $(KMC_OBJS) $(DEP_FLAGS) 
